...
import { Activity, AlertTriangle, BarChart3, Building2, Calendar, FileText, Heart, Home, LogOut, Map, PanelLeft, Settings, User, Users, Wifi, ChevronDown, BriefcaseMedical, Waypoints, Warehouse, ChessKnight } from "lucide-react";
...
const adminMenuItems = [
  ...
  { icon: BarChart3, label: "Requests", path: "/admin/requests" },
            ...
            {user?.role === "admin" && (
              <>
                <div className="px-3 pt-4 pb-2">
                  <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider group-data-[collapsible=icon]:hidden">
                    Administration
                  </h3>
                </div>
                <SidebarMenu className="px-2 py-1">
